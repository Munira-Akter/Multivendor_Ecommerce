                                ...
                                <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="iti iti--allow-dropdown iti--separate-dial-code">
                                            <div class="iti__flag-container">
                                                <div class="iti__selected-flag" role="combobox"
                                                    ...
                                                    title="United States: +1" aria-activedescendant="iti-item-us">
                                                ...
                                                <ul class="iti__country-list iti__hide" id="country-listbox"
                                                    ...
                                                    <li class="iti__country iti__standard" tabindex="-1"
                                                        ...
                                                        </div><span class="iti__country-name">Bosnia and Herzegovina
                                                    ...
                                                    <li class="iti__country iti__standard" tabindex="-1"
                                                        ...
                                                        </div><span class="iti__country-name">São Tomé and Príncipe (São
                                                    ...
                                                    <li class="iti__country iti__standard" tabindex="-1"
                                                        ...
                                                        </div><span class="iti__country-name">Saudi Arabia (‫المملكة
                                                            العربية السعودية‬‎)</span><span
                                                    ...
                                                    <li class="iti__country iti__standard" tabindex="-1"
                                                        ...
                                                        </div><span class="iti__country-name">United Arab Emirates
                                            ...
                                            <input type="tel" id="phone-code" class="form-control"
                                                ...
                                                name="phone" autocomplete="off" style="padding-left: 74px;"
                                    ...
                                    {{-- <div class="form-group text-right">
                                        <button class="btn btn-link p-0 opacity-50 text-reset" type="button"
                                            onclick="toggleEmailPhone(this)"> Uses Email Instead</button>
                                    </div> --}}
                                    ...
                                    {{-- <div class="form-group">
                                        <div class="g-recaptcha"
                                            data-sitekey="6Ld_nrsZAAAAAO-MowQQPfbD9yoio52GiMgUrmRX">
                                            <div style="width: 304px; height: 78px;">
                                                <div><iframe title="reCAPTCHA"
                                                        src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6Ld_nrsZAAAAAO-MowQQPfbD9yoio52GiMgUrmRX&amp;co=ZmlsZTo.&amp;hl=en&amp;v=npGaewopg1UaB8CNtYfx-y1j&amp;size=normal&amp;cb=g2uti9nyb7pz"
                                                        role="presentation" name="a-tjzahgsbxhqb" scrolling="no"
