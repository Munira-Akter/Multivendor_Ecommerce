                ...
                <div class="row gutters-10">
                    ...
                    <div class="col-md-4">
                        <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="h3 fw-700">8 Product(s)</div>
                    ...
                    <div class="col-md-4">
                        <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="h3 fw-700">23 Product(s)</div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled mb-0">
                                    <li class=" py-2"><span>Address : Lorem placeat ut ve</span></li>
                                    <li class=" py-2"><span>Country : Namibia</span></li>
                                    <li class=" py-2"><span>City : Sed ea dolore offici</span></li>
                                    <li class=" py-2"><span>Postal Code : Et et dolore officia</span></li>
                                    <li class=" py-2"><span>Phone : +1 (497) 761-6512</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/cMBGinCzjVy1wOQOSefEZDSHlUJKdx1xd3pqAWUu.jpg"
                                ...
                                <h5 class="fw-600 mb-3 text-primary">Current Package: Olivia Scott</h5>
